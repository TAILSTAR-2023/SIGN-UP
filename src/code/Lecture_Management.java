...
public class Lecture_Management extends InheritanceFrame {
    ...
    private JTextField majortx = new JTextField();           // 학과전공
    private JTextField numtx = new JTextField();             // 학수번호
    private JTextField classtx = new JTextField();           // 분반
    private JTextField subjecttx = new JTextField();         // 교과목명
    private JTextField coursetx = new JTextField();          // 이수구분
    private JTextField scoretx = new JTextField();           // 학점
    private JTextField timetx = new JTextField();            // 요일/시간
    private JTextField lectureroomtx = new JTextField();     // 강의실
